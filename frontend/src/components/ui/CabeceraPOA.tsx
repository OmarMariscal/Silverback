      ...
      <div className="flex items-center space-x-4">
        ...
        {puedeEditar && (
          <button 
            ...
            className="bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-lg font-medium shadow-md transition-all flex items-center disabled:opacity-50"
          >
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            {estaCargando ? 'Enviando...' : 'Enviar a Revisión'}
          </button>
        )}
      </div>
    </header>
